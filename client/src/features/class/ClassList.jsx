                ...
                <tr key={cls._id} className="border-t border-slate-200 hover:bg-slate-50">
                  ...
                  <td className="whitespace-nowrap px-6 py-5 text-right text-sm font-medium space-x-2">
                    ...
                    <button
                      ...
                      disabled={loading}
                      className="inline-flex items-center justify-center rounded-2xl border border-red-200 bg-red-50 px-3 py-2 text-red-700 transition hover:border-red-400 hover:bg-red-100 disabled:cursor-not-allowed disabled:opacity-50 cursor-pointer"
                    >
                      Delete
                    </button>
                  </td>
